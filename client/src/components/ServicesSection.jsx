  ...
  const services = [
    {
      ...
      description: "We strongly believe in research-driven development. Our team actively works on:",
      items: [
      ...
      footer: "We support both academic and industrial research, ensuring originality and proper formatting.",
      color: "purple"
    },
    {
      tag: "Development",
      ...
      footer: "Our focus is on real-world usability, clean implementation, and complete documentation.",
      color: "indigo"
    }
  ];
