    ...
    <div className="pt-28 min-h-screen bg-[#FCFBFF]">
      ...
      <section className="px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900">
            Let’s Talk with <span className="text-purple-600">MakeTechBerry</span>
          </h1>

          <p className="mt-3 text-gray-600 max-w-2xl mx-auto text-base md:text-lg">
            Have a project idea, internship query, or want to collaborate?
            Send us a message and we’ll connect with you.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          {/* RIGHT: CLEAN CONTACT INFO (NOT CARDS) */}
          <div className="bg-white rounded-3xl border border-gray-100 shadow-lg p-8">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#F7F4FF] border border-purple-100">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-gray-900">+91 XXXXX XXXXX</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#F7F4FF] border border-purple-100">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-gray-900">Pune, Maharashtra</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-[#F7F4FF] border border-purple-100">
                ...
                <div>
                  <p className="text-sm text-gray-500 font-semibold">Working Hours</p>
                  <p className="text-base font-bold text-gray-900">
                    Mon - Sat (10 AM - 7 PM)
                  </p>
                </div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              ...
              <button className="w-full px-5 py-3 rounded-2xl bg-white border border-gray-200 text-gray-900 font-bold hover:shadow-sm transition">
                View Projects
              </button>
            </div>
          </div>
      ...
      {/* FAQ SECTION (Different component – accordion style) */}
